...
import DOStore from "./Store";
import DOBon from "./Bon";
import DOClaim from "./Claim";
...
const DOModify = (props) => {
    ...
    const uomList = [{ name: "Tonase" }, { name: "Kubikasi" }, { name: "Rit" }];
    ...
    const getScheduleAdd = async (id) => {
        ...
        if (result.status === 200) {
            ...
            setOriginSelect(result.data.origin_id);
            setPlantSelect(result.data.plant_id);
            setFleetSelect(result.data.fleet_id);
            setOriginSelect(result.data.origin_id);
            setFleetTypeSelect(result.data.fleet_type_id);
            setMultiProductFlag(false);
            if (result.data.multi_product === 1) {
    ...
    const QueryData = async () => {
        ...
        if (id) {
            ...
            if (res.status === 200) {
                ...
                setDeliveredFlag(data.delivered === 1 ? true : false);
    ...
    const onChangePrice = async () => {
        ...
        if (origin > 0 && plant > 0 && fleet_type > 0) {
            let data = await getUjt(effective, origin, plant, product, fleet_type);
                            ...
                            <TabPanel header="Surat Jalan">
                                <form onSubmit={handleSubmit} autoComplete="off">
                                    <Accordion activeIndex={activeIndex} onTabChange={(e) => setActiveIndex(e.index)} multiple>
                                            ...
                                            <div className="p-fluid">
                                                <div className="grid">
                                                    <div className="col-12 md:col-4">
                                                        <Panel header="Informasi Driver" className="h-full">
                                                            <div className="grid">
                                                                <div className="col-8">
                                                                ...
                                                                <div className="col-12 md:col-6 lg:col-6">
                                                                    <Panel header="Batang">
                                                                        ...
                                                                        <div className="field flex align-items-center">
                                                                            ...
                                                                            <label htmlFor="running1" className="ml-2">
                                                                                Batang
                                                                            </label>
                                                                        </div>
                                                                ...
                                                                <div className="col-12 md:col-6 lg:col-6">
                                                                    <Panel header="Serep">
                                                                        ...
                                                                        <div className="field flex align-items-center">
                                                                            ...
                                                                            <label htmlFor="running2" className="ml-2">
                                                                                Serep
                                                                            </label>
                                                                        </div>
                                                    ...
                                                    <div className="col-12 md:col-4">
                                                        <Panel header="Informasi Surat Jalan">
                                                            <AutoCompleteComp
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    values.company_id.id = e.value.id;
                                                                }}
                                                                disabled={false}
                                                            />
                                                            <AutoCompleteComp
                                                                ...
                                                                setSelectValue={(e) => {
                                                                    setBusinessSelect(e);
                                                                    values.sales_type_id.id = e.id;
                                                                }}
                                                                onChange={(e) => {
                                                                    setBusinessSelect(e.value);
                                                                    values.sales_type_id.id = e.value.id;
                                                                }}
                                                            ...
                                                            <AutoCompleteComp
                                                                ...
                                                                field="schedule_id"
                                                                title="No Jadwal"
                                                                showField="schedule_no"
                                                                errors={errors}
                                                                touched={touched}
                                                                disabled={disabledOpen}
                                                                models={scheduleData}
                                                                itemTemplate={itemTemplate}
                                                                queryData={(e) => getSchedule(e)}
                                                                value={scheduleSelect}
                                                                setSelectValue={(e) => setScheduleSelect(e)}
                                                                onChange={(e) => {
                                                                    onChangeSchedule(e);
                                                                }}
                                                            />
                                                            ...
                                                            <AutoCompleteComp
                                                                ...
                                                                setSelectValue={(e) => {
                                                                    ...
                                                                    values.order_type_id.id = e.id;
                                                                }}
                                                                onChange={(e) => {
                                                                    setOrderTypeSelect(e.value);
                                                                    values.order_type_id.id = e.value.id;
                                                                    onChangePrice();
                                                                    setChangeStatus(true);
                                                                }}
                                                            />
                                                            <AutoCompleteComp
                                                                ...
                                                                touched={touched}
                                                                models={originData}
                                                                disabled={!returnedFlag}
                                                                queryData={(e) => getOrigin(e)}
                                                                value={originSelect}
                                                                setSelectValue={(e) => {
                                                                    setOriginSelect(e);
                                                                    originRef.current = e.id;
                                                                    values.origin_id.id = e.id;
                                                                }}
                                                                onChange={(e) => {
                                                                    setOriginSelect(e.value);
                                                                    originRef.current = e.value.id;
                                                                    onChangePrice();
                                                                    values.origin_id.id = e.value.id;
                                                                    setChangeStatus(true);
                                                                }}
                                                            />
                                                            <AutoCompleteComp
                                                                ...
                                                                setSelectValue={(e) => {
                                                                    setPlantSelect(e);
                                                                    plantRef.current = e.id;
                                                                    values.plant_id.id = e.id;
                                                                }}
                                                                onChange={(e) => {
                                                                    setPlantSelect(e.value);
                                                                    plantRef.current = e.value.id;
                                                                    onChangePrice();
                                                                    values.plant_id.id = e.value.id;
                                                                    setChangeStatus(true);
                                                                }}
                                                            />
                                                        </Panel>
                                                        <Panel header="SJ Kembali" className="mt-4">
                                                            <div className="grid">
                                                                <div className="col-3">
                                                                    <InputSwitchComp
                                                                        className="field col-12 md:col-12"
                                                                        ...
                                                                        field="returned"
                                                                        title="SJ Kembali"
                                                                        checked={returnedFlag}
                                                                        onChange={(e) => {
                                                                            setReturnedFlag(e.value);
                                                                            values.returned = e.value ? 1 : 0;
                                                                            values.receive_date = e.value ? formatDateTimeString(new Date()) : null;
                                                                            setFinalShiftSelect(shiftData[0].name);
                                                                        }}
                                                                        onBlur={handleBlur}
                                                                        errors={errors}
                                                                        touched={touched}
                                                                ...
                                                                <div className="col-4">
                                                                    <DropDownComp
                                                                        ...
                                                                        optionValue="name"
                                                                        options={shiftData}
                                                                        value={finalShiftSelect}
                                                                        errors={errors}
                                                                        touched={touched}
                                                                        onBlur={handleBlur}
                                                                        onChange={(e) => {
                                                                            setFinalShiftSelect(e.value);
                                                                            values.final_shift = e.value;
                                                                            setChangeStatus(true);
                                                                        }}
                                                                    />
                                                                </div>
                                                                <div className="col-5">
                                                                    {/* <DateTimePickerComp
                                                                        ...
                                                                        validate={true}
                                                                        field="receive_date"
                                                                        title="Tgl terima tujuan"
                                                                        disabled={!returnedFlag}
                                                                        value={values.receive_date}
                                                                        onChange={(e) => {
                                                                            values.receive_date = e;
                                                                            setChangeStatus(true);
                                                                        }}
                                                                        onBlur={handleBlur}
                                                                        errors={errors}
                                                                    ...
                                                                    <div className="col-12">
                                                                    <label className="field col-12 md:col-12">Tgl Terima Tujuan</label>
                                                                    <Calendar
                                                                        id="receive_date"
                                                                        field="receive_date"
                                                                        disabled={!returnedFlag}
                                                            ...
                                                            <div className="grid">
                                                                <div className="col-3">
                                                                    <InputSwitchComp
                                                                        ...
                                                                        onChange={(e) => {
                                                                            setDeliveredFlag(e.value);
                                                                            values.delivered = e.value ? 1 : 0;
                                                                        }}
                                                                        onBlur={handleBlur}
                                                                        errors={errors}
                                                                        touched={touched}
                                                                ...
                                                                <div className="col-9">
                                                                    <InputTextComp
                                                                        ...
                                                                        field="shipment_no"
                                                                        title="No Resi"
                                                                        value={values.shipment_no}
                                                                        onChange={handleChange}
                                                                        onBlur={handleBlur}
                                                                        onInput={() => setChangeStatus(true)}
                                                                        errors={errors}
                                                                        touched={touched}
                                                                    />
                                                                </div>
                                                            ...
                                                            <div className="grid">
                                                                <div className="col-12">
                                                                    <InputTextComp
                                                                        className="field col-12 md:col-12"
                                                                        validate={true}
                                                                        field="shipment_vendor"
                                                                        title="Nama Kurir"
                                                                        value={values.shipment_vendor}
                                                                        onChange={handleChange}
                                                                        onBlur={handleBlur}
                                                                        onInput={() => setChangeStatus(true)}
                                                                        errors={errors}
                                                    ...
                                                    <div className="col-12 md:col-4">
                                                        <Panel header="Keterangan">
                                                            ...
                                                            <div className="grid">
                                                                <div className="col-12">
                                                                    <label className="field col-12 md:col-12">Tgl Surat Jalan</label>
                                                                    <Calendar id="calendar-24h" field="issue_date" className="field col-12 md:col-12" value={values.issueDate} onChange={(e) => setDateTime24h(e.value)} showTime hourFormat="24" showIcon title="Tgl Keluar" />
                                                                </div>
                                                            </div>
                                                            <div className="grid">
                                                                <div className="col-6">
                                                                    <label className="field col-12 md:col-12">Tgl Keluar</label>
                                                                    <Calendar id="calendar-24h" field="issue_date" className="field col-12 md:col-12" value={datetime24h} onChange={(e) => setDateTime24h(e.value)} showTime hourFormat="24" showIcon title="Tgl Keluar" />
                                                                </div>
                                                                <div className="col-6">
                                                                    <label className="field col-12 md:col-12">Tgl Kembali</label>
                                                            ...
                                                            <div className="grid">
                                                                <div className="col-6">
                                                                    <InputNumberComp
                                                                        ...
                                                                        field="volume_plant"
                                                                        title="Odo Awal"
                                                                        value={values.volume_plant}
                                                                        onChange={(e) => (values.volume_plant = e.value)}
                                                                        onBlur={handleBlur}
                                                                        onInput={() => setChangeStatus(true)}
                                                                        errors={errors}
                                                                        touched={touched}
                                                            ...
                                                            <div className="grid">
                                                                ...
                                                                <div className="col-6">
                                                                    <InputTextComp
                                                                        className="field col-12 md:col-12"
                                                                        validate={true}
                                                                        field="total_reimbursment"
                                                                        title="Total Reimbursment"
                                                                        value={values.total_reimbursment}
                                                                        onChange={handleChange}
                                                                        onBlur={handleBlur}
                                                                        onInput={() => setChangeStatus(true)}
                                                                        errors={errors}
                                                    ...
                                                    {/* <div className="col-12 md:col-2">
                                                        <Panel header="Info Kendaraan" className="h-full">
                                        ...
                                        <AccordionTab header="List Toko">
                                            <DOStore id={id} models={storeList} setModels={onSetModels} empty={emptyDetailModel} rowClassName={(e) => rowClassNameTemplate(e)} setChangeStatus={() => setChangeStatus(true)} toast={toast} />
                                        </AccordionTab>
                                        <AccordionTab header="List Bon">
                                            <DOBon id={id} models={storeList} setModels={onSetModels} empty={emptyDetailModel} rowClassName={(e) => rowClassNameTemplate(e)} setChangeStatus={() => setChangeStatus(true)} toast={toast} />
                                        </AccordionTab>
                                        <AccordionTab header="List Klaim">
                                            <DOClaim id={id} models={storeList} setModels={onSetModels} empty={emptyDetailModel} rowClassName={(e) => rowClassNameTemplate(e)} setChangeStatus={() => setChangeStatus(true)} toast={toast} />
                                        </AccordionTab>
                                        {multiProduct && (
...
export default React.memo(GlobalConsumer(DOModify), comparisonFn);
