                                                    ...
                                                    <div className="col-12 md:col-3">
                                                        ...
                                                        <Panel header="SJ Kembali" className="mt-3">
                                                            <div className="p-fluid grid">
                                                                ...
                                                                <DateTimePickerComp className="field col-12 md:col-6" validate={true} field="receive_date" title="Tgl terima tujuan" disabled={!returnedFlag} value={values.receive_date} onChange={(e) => { values.receive_date = e; setChangeStatus(true); }} onBlur={handleBlur} errors={errors} touched={touched} />
                                                                <InputSwitchComp className="field col-12 md:col-3" validate={true} field="delivered" title="SJ diterima" checked={deliveredFlag} onChange={(e) => { setDeliveredFlag(e.value); values.delivered = e.value ? 1 : 0; }}
                                                                    onBlur={handleBlur} errors={errors} touched={touched} />
                                                                    <InputTextComp className="field col-12 md:col-9" validate={true} field="shipment_no" title="No Resi" value={values.shipment_no} onChange={handleChange} onBlur={handleBlur} onInput={() => setChangeStatus(true)} errors={errors} touched={touched} />
                                                                <InputTextComp className="field col-12 md:col-12" validate={true} field="shipment_vendor" title="Nama Kurir" value={values.shipment_vendor} onChange={handleChange} onBlur={handleBlur} onInput={() => setChangeStatus(true)} errors={errors} touched={touched} />
