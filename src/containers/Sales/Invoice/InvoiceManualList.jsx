...
const InvoiceManualList = () => {
    ...
    const actionNew = () => {
        return history.push({
            pathname:  "/sales/office/invoice-manual/create",
            state: {}
        });
    }
    ...
    const actionEdit = (data) => {
        return history.push({
            pathname:  "/sales/office/invoice-manual/edit/" + data.id,
            state: {}
        });
    }
...
export default React.memo(InvoiceManualList, comparisonFn);
