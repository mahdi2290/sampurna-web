...
import * as CrudService from '../../service/Master/OccupationService';
...
const OccupationList = () => {
    ...
    if (localModeStorage === "static" ) {
        columnsTable = [
            { field: 'name', header: 'Nama Occupation', sortable: false, style: "percent", width: 1, },
            { field: 'action', header: '' },
        ];
    } else {
        columnsTable = [
...
export default React.memo(OccupationList, comparisonFn);
