...
const BankList = () => {
    ...
    if (localModeStorage === "static" ) {
        columnsTable = [
            { field: 'name', header: 'Nama Bank', sortable: false, style: "percent", width: 31.5},
            { field: 'swift', header: 'Swift', sortable: false, style: "percent", width: 15},
            { field: 'bi', header: 'BI', sortable: false, style: "percent", width: 15},
            { field: 'city_id.name', header: 'Kota', sortable: false, style: "percent", width: 35},
            { field: 'action', header: '' },
        ];
    } else {
        columnsTable = [
...
export default React.memo(BankList, comparisonFn);
