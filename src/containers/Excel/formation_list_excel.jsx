...
export const createFormationListExcel = (data) => {
...
const handleExport = (data) => {
    ...
    data.forEach((formation) => {
        if (formation.lists !== null) {
            const formation_value = formation.formation_id.name;
            const formation_name = formation_value.replace("/", '');
            ...
            XLSX.utils.book_append_sheet(wb, sheet, formation_name);
        }
    });
