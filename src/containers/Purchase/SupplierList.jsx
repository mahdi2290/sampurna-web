...
const SupplierList = () => {
    ...
    const columnsTable = [
        ...
        { field: 'name', header: 'Nama', sortable: false, style: "percent", width: 1.3 },
    ...
    const actionNew = () => {
        return history.push({
            pathname: "/purchase/master/supplier/create",
            state: {}
        });
    }
...
export default React.memo(SupplierList, comparisonFn);
