                            ...
                            <div className="page-header">
                                <div className="row">
                                    <div className="column">
                                        <img src={process.env.PUBLIC_URL + "/assets/images/logo/sms.png"} className="logo-image" alt="Logo" />
                                        <div className="company-name">PT Sampurna Makmur Sejahtera</div>
                                    </div>
                                    <div className="column">
