...
const DateView = ({startDate, lastDate, selectDate, getSelectedDay, primaryColor, labelFormat, marked}) => {
    ...
    const firstSection = {marginLeft: '30px'};
    const selectedStyle = {fontWeight:"bold", marginTop: '-3px', paddingTop: '3px', width:"40px",height:"40px", backgroundColor: '#EEF2FF',  borderRadius:"50%",border:`2px solid #EEF2FF`,color:primaryColor};
